...
/*You are driving a little too fast, and a police officer stops you. Write code
  ...
  61 and 80 inclusive, the result is 1. If speed is 81 or more, the result 
  is 2. Unless it is your birthday -- on that day, your speed can be 5 
  higher in all cases.*/
public class CaughtSpeeding {
	...
	public static void main(String[] args) {
		CaughtSpeeding g = new CaughtSpeeding();
		System.out.println(g.caughtSpeeding(84, false));
	}
}
