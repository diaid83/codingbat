 ...
 *each pair. If any pair sums to exactly 10, the result is 10. Otherwise if
 *the ab sum is exactly 10 more than either bc or ac sums, the result is 5.
 *Otherwise the result is 0.*/
public class BlueTicket {
	public int blueTicket(int a, int b, int c) {
		int ab = a+b; int ac = a+c; int bc = b+c;
	...
	public static void main(String[] args) {
		BlueTicket g = new BlueTicket();
		System.out.println(g.blueTicket(9, 1, 0));
